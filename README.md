...
| **Sound** | Paste a YouTube video or playlist link and play it in a privacy-enhanced embedded player, or save named links for later. **Play here** needs the Sound tab to remain open; **Open in YouTube** hands the link to the official app, where a Premium account can keep it playing in the background. Saved links live on this device. |
